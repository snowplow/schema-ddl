...
class SchemaListSpec extends Specification { def is = s2"""
  ...
  def e3 = {
    ...
    val output = ModelGroupList.groupSchemas(
  ...
  def e4 = {
    ...
    val modelGroup = ModelGroupList.groupSchemas(group).head
  ...
  def e5 = {
    ...
    val modelGroupWithGapInAddition = ModelGroupList.groupSchemas(
      tempGroup1
    ...
    val modelGroupWithGapInRevision = ModelGroupList.groupSchemas(
      tempGroup2
  ...
  def e9 = {
    ...
    val ambiguousModelGroup = ModelGroupList.groupSchemas(ambiguousGroup).head
    ...
    val modelGroupWithGap = ModelGroupList.groupSchemas(groupWithGap).head
