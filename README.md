...
```scala
libraryDependencies += "com.snowplowanalytics" %% "schema-ddl" % "0.14.4"
```
...
[api-reference]: https://snowplow.github.io/schema-ddl/0.14.4/com/snowplowanalytics/iglu/schemaddl/index.html
