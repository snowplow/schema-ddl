...
```scala
libraryDependencies += "com.snowplowanalytics" %% "schema-ddl" % "0.15.1"
```
...
[api-reference]: https://snowplow.github.io/schema-ddl/0.15.1/com/snowplowanalytics/iglu/schemaddl/index.html
