...
```scala
libraryDependencies += "com.snowplowanalytics" %% "schema-ddl" % "0.27.0"
```
...
[api-reference]: https://snowplow.github.io/schema-ddl/0.27.0/com/snowplowanalytics/iglu/schemaddl/index.html
