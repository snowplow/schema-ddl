...
```scala
libraryDependencies += "com.snowplowanalytics" %% "schema-ddl" % "0.13.1"
```
...
[api-reference]: https://snowplow-incubator.github.io/schema-ddl/0.13.1/com/snowplowanalytics/iglu/schemaddl/index.html
